...
<header className="header">
  <div className="header-container">
    <div className="header-text">
      <p>
      <span style={{ fontSize: '38px' }}>Tiffany Tran</span> is a <span style={{ fontWeight: '450' }} className="yellow">game programmer</span> passionate about creativity and <span className="blue">leadership</span>. 
      ...
      <a href="more.html" className="more">
        more →
      </a>
  </div>
</header>
